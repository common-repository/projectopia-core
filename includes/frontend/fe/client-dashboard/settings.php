<div class="cqpim_block">
	<div class="cqpim_block_title">
		<div class="caption">
			<i class="fa fa-cog font-green-sharp" aria-hidden="true"></i> <?php esc_html_e('My Profile', 'projectopia-core'); ?>
		</div>
	</div>
			...
			<div class="cqpim-dash-item-inside">
				<div id="cqpim_backend_quote">
					...
					<form id="client_settings">
						...
						?>
						<h4 style="margin-top:20px"><?php esc_html_e('Change Password', 'projectopia-core'); ?></h3>
						...
						if ( $client_type == 'admin' ) { 
							...
							$client_contacts = get_post_meta($assigned, 'client_contacts', true);
							$notifications = ''; 
							if ( ! empty( $client_contacts[ $user->ID ]['notifications'] ) ) {
						...
						<br />
						<input type="checkbox" name="no_tasks_comment" id="no_tasks_comment" value="1" <?php if ( $no_tasks_comment == 1 ) { echo 'checked="checked"'; } ?>  /> <?php esc_html_e('Only notify me if a task has a new comment added.', 'projectopia-core'); ?>
						<br />
						<?php if ( pto_has_addon_active_license( 'pto_st', 'tickets' ) ) { ?>
							...
							<br />
							<input type="checkbox" name="no_tickets_comment" id="no_tickets_comment" value="1" <?php if ( $no_tickets_comment == 1 ) { echo 'checked="checked"'; } ?>  /> <?php esc_html_e('Only notify me if a ticket has a new comment added.', 'projectopia-core'); ?>
							<br />
						<?php } ?>
						...
						<br />
						<input style="float:left; margin-left:0" type="submit" id="client_settings_submit" class="cqpim_button bg-blue font-white mt-20 rounded_2" value="<?php esc_html_e('Update Settings', 'projectopia-core'); ?>" />
						<div class="clear"></div>
						<br />
