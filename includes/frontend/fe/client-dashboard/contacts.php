<div class="cqpim_block">
	<div class="cqpim_block_title">
		<div class="caption">
			<i class="fa fa-users font-green-sharp" aria-hidden="true"></i> <?php esc_html_e('Manage Contacts', 'projectopia-core'); ?>
		</div>
	</div>
	<div class="cqpim-dash-item-inside">
		...
		<?php } if ( $client_settings == 1 ) { ?>
			<br /><br />
			<button style="float:left; margin-left:0" id="add_client_team" class="cqpim_button bg-blue font-white rounded_2"><?php esc_html_e('Add Contact', 'projectopia-core'); ?></button>
		<?php } ?>
		<div class="clear"></div>
		<div id="add_client_team_ajax_container" style="display:none">
			<div id="add_client_team_ajax">
				<div style="padding:12px">
					...
					<button class="cancel-colorbox cqpim_button bg-red font-white rounded_2"><?php esc_html_e('Cancel', 'projectopia-core'); ?></button>
					<button id="add_client_team_submit" class="cqpim_button bg-blue font-white right rounded_2"><?php esc_html_e('Add Client Contact', 'projectopia-core'); ?><span id="ajax_spinner_add_contact" class="ajax_loader" style="display:none"></span></button>
				</div>
			</div>
		</div>
	</div>
