	...
	<div class="cqpim-dash-item-full grid-item tasks-box">
		<div class="cqpim_block">
			<div class="cqpim_block_title">
				<div class="caption">
					<span class="caption-subject font-light-violet sbold"><?php esc_html_e('Project Messages', 'projectopia-core'); ?></span>
				</div>	
			</div>
			<?php
			...
			<a href="#" id="add_message_trigger" class="cqpim_button right font-white bg-violet op mt-20 rounded_2"><?php esc_html_e('Send Message', 'projectopia-core'); ?></a>
			<div class="clear"></div>
