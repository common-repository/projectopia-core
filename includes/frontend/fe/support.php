...
$p_status = '<span class="cqpim_button cqpim_small_button status" style="background-color:' . esc_attr( pto_adjust_color_brightness( $ticket_status_color, 0.8 ) ) .' !important;color:'. esc_attr( $ticket_status_color ) . ' !important;">' . ucwords( $ticket_status_new ) . '</span>';
	...
	<div class="masonry-grid">
		...
		<div class="cqpim-dash-item-double grid-item">
			<div id="ticket_container" class="cqpim_block">
				<div class="cqpim_block_title">
					<div class="caption">
						<span class="caption-subject font-green-sharp sbold"><?php esc_html_e('Ticket Details', 'projectopia-core'); ?></span>
					</div>
				</div>
		...
		<div class="cqpim-dash-item-triple grid-item">
			<div id="ticket_container" class="cqpim_block">
				<div class="cqpim_block_title">
					<div class="caption">
						<span class="caption-subject font-green-sharp sbold"><?php esc_html_e('Ticket Updates', 'projectopia-core'); ?></span>
					</div>
				</div>
				<?php
				...
				<div id="add_ticket_update">
					<div class="cqpim_block_title">
						<div class="caption">
							<span class="caption-subject font-green-sharp sbold"><?php esc_html_e('Update Ticket', 'projectopia-core'); ?></span>
						</div>
					</div>
							...
							<?php
								foreach ( $support_ticket_priorities as $key => $priority_color ) {
									printf(
										...
										esc_attr( $key ),
										selected( $ticket_priority, $key, false ),
										esc_html( $key )
									);
								}
							?>
					...
					<div class="clear"></div>
					<br />
					<a href="#" id="update_support" class="cqpim_button op right font-white bg-blue rounded_2 mt-20"><?php esc_html_e('Update Ticket', 'projectopia-core'); ?></a>
					<div class="clear"></div>
				</div>					
			</div>
		</div>
		<div class="cqpim-dash-item-double grid-item">
			<div id="ticket_container" class="cqpim_block">
				<div class="cqpim_block_title">
					<div class="caption">
						<span class="caption-subject font-green-sharp sbold"><?php esc_html_e('Ticket Files', 'projectopia-core'); ?></span>
					</div>
				</div>
				<?php 
